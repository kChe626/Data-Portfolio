...
| [**Bank Operations KPI Dashboard**](https://github.com/kChe626/bank-operations-kpi-dashboard/blob/main/README.md) | ![Bank Preview](https://github.com/kChe626/bank-operations-kpi-dashboard/blob/main/README.md)<br>**Focus:** Python cleaning, SQL segmentation, and Power BI analysis of campaign conversion rates. | Python, MySQL, Power BI | Improves marketing operations by identifying high-conversion segments, optimizing campaign timing, and streamlining call center workflows. |
